...
export const EN_AI = {
	...
	"ai.web.title": "Send the prompt on {site}, then copy the answer",
	...
	"ai.web.dropFiles": "Drag the file below onto {site}, then send.",
	"ai.web.dropFilesMany": "Drag the files below onto {site}, all at once, then send.",
	"ai.web.dragOne": "Drag",
