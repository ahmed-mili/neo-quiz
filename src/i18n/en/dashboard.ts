...
export const EN_DASHBOARD = {
	...
	"dashboard.home.statDue": "Due now",
	"dashboard.home.statDueSub": "spaced reviews",
	...
	"dashboard.quizzes.menuConvertLearn": "Convert to learning mode",
	"dashboard.quizzes.convertLearnTitle": "Convert this quiz?",
	"dashboard.quizzes.convertLearnBody": "The existing explanations will be shown as lessons before active recall. The questions stay unchanged, and the timed exam remains available after learning.",
	"dashboard.quizzes.convertLearnCta": "Convert",
	"dashboard.quizzes.learnConverted": "“{title}” is now a learning quiz",
	"dashboard.quizzes.learnAlready": "This quiz is already in learning mode",
	"dashboard.quizzes.learnConvertError": "The quiz could not be converted",
