...
export const FR_AI: Record<keyof typeof EN_AI, string> = {
	...
	"ai.usage.window7d": "7 j",
	"ai.usage.window7dOpus": "7 j Opus",
	"ai.usage.windowHours": "{n} h",
	"ai.usage.windowDays": "{n} j",
	"ai.usage.windowPlan": "Forfait",
	"ai.usage.resetInMinutes": "réarmé dans {n} min",
	"ai.usage.resetInHours": "réarmé dans {n} h",
	"ai.usage.resetInDays": "réarmé dans {n} j",
