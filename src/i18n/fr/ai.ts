...
export const FR_AI: Record<keyof typeof EN_AI, string> = {
	...
	"ai.web.dropFiles": "Glissez le fichier ci-dessous sur {site}, puis envoyez.",
	"ai.web.dropFilesMany": "Glissez les fichiers ci-dessous sur {site}, tous d'un coup, puis envoyez.",
