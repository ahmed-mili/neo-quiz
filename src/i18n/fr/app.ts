...
export const FR_APP: Record<keyof typeof EN_APP, string> = {
	...
	"app.comptes.usageTerminalOpened": "Antigravity CLI s'ouvre dans un terminal : tapez /usage dedans pour voir votre quota. Au tout premier lancement, il demande d'abord de le configurer.",
