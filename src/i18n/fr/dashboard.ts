...
export const FR_DASHBOARD: Record<keyof typeof EN_DASHBOARD, string> = {
	...
	"dashboard.home.statDue": "À revoir maintenant",
	"dashboard.home.statDueSub": "révisions espacées",
	...
	"dashboard.quizzes.menuConvertLearn": "Convertir en apprentissage",
	"dashboard.quizzes.convertLearnTitle": "Convertir ce quiz ?",
	"dashboard.quizzes.convertLearnBody": "Les explications existantes seront montrées comme leçons avant le rappel actif. Les questions restent inchangées et l’examen chronométré restera accessible après l’apprentissage.",
	"dashboard.quizzes.convertLearnCta": "Convertir",
	"dashboard.quizzes.learnConverted": "« {title} » est maintenant un quiz d’apprentissage",
	"dashboard.quizzes.learnAlready": "Ce quiz est déjà en mode apprentissage",
	"dashboard.quizzes.learnConvertError": "Impossible de convertir ce quiz",
